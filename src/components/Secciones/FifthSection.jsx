    ...
    <section className="px-[40px] py-[48px] bg-[#f7f5f3]">
      <div className="flex m-[0.5rem]">
        <div className="flex flex-col justify-center max-w-[50%]">
          <h3 className="text-[#2a5b45] font-semibold text-3xl py-4">
            Pruébalo en nuestro coffee shop
          </h3>
          <p className="fsText py-4">
          ...
          <div className="flex items-center py-4">
            ...
            <img className="ml-3"
              src="https://firebasestorage.googleapis.com/v0/b/cafe-de-altura-90fa2.appspot.com/o/flechaRight.png?alt=media&token=12e038e9-4276-4907-972a-0084f7de6fe7"
              alt=""
            />
          </div>
        </div>
        <img
          className="fsImage rounded-[20px] shadow-xl mx-[auto] w-2/4"
