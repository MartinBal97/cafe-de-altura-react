...
export default function FourthSection() {
  return (
    <section className="bg-[#2a5b45] text-white text-center p-8">
      <h2 className="tsTitle my-[2rem]">Preguntas frecuentes</h2>
      <div className="my-[2rem] flex flex-col justify-center items-center">
        ...
        <Faq
          ...
          answer={
            "Lorem ipsum dolor sit amet consectetur adipisicing elit. Unde beatae excepturi aut blanditiis, eum nesciunt recusandae tempore illum nihil error tempora dolor quod neque quasi quae hic rerum sint soluta."
          }
        />
      </div>
      <div className="tsVerMas my-[2rem] flex justify-center items-center">
        <Link className="mr-[0.7rem]" to="/">
          Resolvemos tus dudas
        </Link>
        <img
          src="images/flechaRightWhite.png"
          alt="flechaRightWhite"
        />
      </div>
    </section>
  );
